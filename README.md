...
Задача проекта — уложить 3B-модель в ограничения ноутбучной RTX 3060 и разобраться,
какие параметры инференса чем ограничены. Все значения в конфиге выбраны по расчёту,
а не подбором.
...
- [ ] Нагрузочное тестирование: TTFT и throughput под параллельной нагрузкой
- [ ] FastAPI-слой со
